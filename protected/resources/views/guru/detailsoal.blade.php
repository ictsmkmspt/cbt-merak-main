...
<head>
  ...
  <title>Detail Soal - Ujian CBT</title>
  ...
  <!-- <link rel="stylesheet" href="{{url('css/sdk-inline-ckeditor.css')}}"> -->
                  ...
                  <script>
                    $(document).ready(function() {
                      ...
                      $('#hapussoal{{ $detailsoal->id }}').click(function () {
                        if (!confirm('Apakah anda yakin ingin menghapusnya?')) return false;
...
<script>
  ...
  function initCK() {
    ...
    CKEDITOR.config.extraPlugins = 'widget,widgetselection,toolbar,clipboard,filetools,notification,lineutils,notificationaggregator,uploadwidget,uploadimage';

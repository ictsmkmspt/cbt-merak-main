      ...
      <table class="table table-bordered" id="tabelsoal">
        ...
        <tr>
          ...
          <td align="center">
            ...
            <a href="{{ url('detail-hasil-soal/'.$jawab->id_kelas.'/'.$jawab->id_soal) }}" class="btn btn-xs btn-info"  data-toggle="tooltip" title="Detail rekap ujian per kelas."><i class="fa fa-search"></i> Detail</a>
            ...
            {{-- <a href="#" id="btnhapus{{ $jawab->id_kelas }}"
                class="btn btn-xs btn-danger" 
                data-toggle="tooltip" 
                title="Akan menghapus seluruh hasil ujian dari kelas yang dipilih. Data yang dihapus tidak bisa dikembalikan." 
                <i class="fa fa-trash-o"></i> Hapus
            </a> --}}
            <a href="{{ url('tampilhasil/'.$jawab->id_kelas.'/'.$jawab->id_soal) }}" class="btn btn-xs btn-primary" data-toggle="tooltip" title="Download seluruh data hasil Ujian Ke dalam format Excel" target="_blank"><i class="fa fa-desktop"></i> Absensi & KKM</a></td>
          </td>
        </tr>
